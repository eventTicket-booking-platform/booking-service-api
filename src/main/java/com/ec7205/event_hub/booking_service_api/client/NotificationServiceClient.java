...
public interface NotificationServiceClient {
    ...
    StandardResponseDto sendBookingConfirmed(@RequestBody BookingConfirmedNotificationRequest request);

    @PostMapping("/notification-service/api/v1/internal/notifications/booking-cancelled")
    StandardResponseDto sendBookingCancelled(@RequestBody BookingCancelledNotificationRequest request);
}
